# Media + Prometheus measurement (2026-08-06)

Prometheus enabled: `infra/livekit.yaml` `prometheus_port: 6789`, compose port `6789:6789`.

Run: [media-prom-20260806-v2](media-prom-20260806-v2/SUMMARY.md)

Metrics scraped: `livekit_packet_bytes` (Mbps), `livekit_packet_total` (pkt/s), `livekit_packet_loss_percent_*`, rooms/participants gauges.
